...
function RetrieveComponents()
	...
	Execute = exports['skdev-base']:FetchComponent('Execute')
	...
	Chat = exports['skdev-base']:FetchComponent('Chat')
	Logger = exports['skdev-base']:FetchComponent('Logger')
	Generator = exports['skdev-base']:FetchComponent('Generator')
	Phone = exports['skdev-base']:FetchComponent('Phone')
	Jobs = exports['skdev-base']:FetchComponent('Jobs')
	Vehicles = exports['skdev-base']:FetchComponent('Vehicles')
	Inventory = exports['skdev-base']:FetchComponent('Inventory')
	Sequence = exports['skdev-base']:FetchComponent('Sequence')
end

AddEventHandler('Core:Shared:Ready', function()
	exports['skdev-base']:RequestDependencies('Evidence', {
		'Fetch',
		'Utils',
		'Execute',
		'Chat',
		...
		if #error > 0 then
			exports['skdev-base']:FetchComponent('Logger'):Critical('Evidence', 'Failed To Load All Dependencies')
			return
		end
		RetrieveComponents()
